...
public class GetReserveServlet extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(GetReserveServlet.class);
    ...
    private IResponse getReserve(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            LOGGER.info("Get authorized/reserved payment details id = " + getTransactionResponseMessage.getPayUReference()
                    + " and result code = " + getTransactionResponseMessage.getResultCode());
            ResultPrinter.addResult(req, resp, "Get Authorized/Reserved Payment Details", JSONFormatter.toJSON(getTransaction),
