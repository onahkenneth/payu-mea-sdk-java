...
public class SDKUtil {
     ...
     */
    public static String validateAndGet(Map<String, String> map, String key) throws PayUSOAPException {
        if (map == null || key == null) {
            throw new PayUSOAPException("Map or Key cannot be null");
        }
        ...
        if (value == null || value.equals("")) {
            ...
            if (value == null || value.equals("")) {
                throw new PayUSOAPException(key + " cannot be null");
            }
        }
        return value;
    }
